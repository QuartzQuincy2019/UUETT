...
var lang = {
    "en-US": {
        ...
        "_time": "Time",
        "_default": "Default",
        "_author_link": "~ UUETT Instru. & Wiki on Github ~",
        ...
        "instructions":
            ...
            + "<br>***If you want to enter a line break (i.e. <strong>Enter</strong> key) in a typing task, type\"&lt;br&gt;\" or \"&lt;br \\\\&gt;\" into the file."
    ...
    "zh-CN": {
        ...
        "_time": "时间",
        "_default": "默认值",
        "_author_link": "~ GitHub UUETT 使用说明与Wiki ~",
        ...
        "instructions":
            ...
            + "<br>***如果您想要在任务文本中添加一个换行符 (也就是<strong>回车</strong>键)，请用\"&lt;br&gt;\"或\"&lt;br \\\\&gt;\"来代替。（千万不可直接在任务文本中换行！）"
    ...
    "zh-TW": {
        ...
        "_time": "時間",
        "_default": "默認值",
        "_author_link": "~ GitHub UUETT 使用説明與Wiki ~",
        ...
        "instructions":
            ...
            + "<br>***如果您想要在任務文本中添加一個換行符 (也就是<strong>回車</strong>鍵)，請用\"&lt;br&gt;\"或\"&lt;br \\\\&gt;\"以代替。（千萬不可直接在任務文本中換行！）"
